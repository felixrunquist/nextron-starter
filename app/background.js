...
/* harmony import */ var electron_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! electron-store */ "electron-store");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers */ "./main/helpers/index.js");
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on('get-messages', event => {
  event.reply('messages', store.get('messages') || []);
});
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on('add-message', (_event, arg) => {
